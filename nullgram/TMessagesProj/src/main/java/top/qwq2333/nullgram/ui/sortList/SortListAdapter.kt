package top.qwq2333.nullgram.ui.sortList
...
import top.qwq2333.nullgram.config.ConfigManager.toggleBoolean
...
abstract class SortListAdapter(
    ...
    init {
        val savedOrder = ConfigManager.getStringOrDefault(define, null)
        if (savedOrder != null) {
